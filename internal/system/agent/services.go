...
import (
	...
	"sup-sys-mgmt-agent/internal/system/agent/executor"
)
...
func InvokeOperation(action string, services []string) bool {
	...
	for _, service := range services {
		...
		case STOP:
			...
			case internal.MockMqttDriver1ServiceKey:
				ec.StopService(internal.MockMqttDriver1ServiceKey)
				break

			case internal.MockMqttDriver2ServiceKey:
				ec.StopService(internal.MockMqttDriver2ServiceKey)
				break

			case internal.MockMqttDriver3ServiceKey:
				ec.StopService(internal.MockMqttDriver3ServiceKey)
				break
		...
		case START:
			...
			case internal.MockMqttDriver1ServiceKey:
				executor.StartDockerContainerCompose(internal.MockMqttDriver1ServiceKey, Configuration.ComposeUrl)
				break

			case internal.MockMqttDriver2ServiceKey:
				executor.StartDockerContainerCompose(internal.MockMqttDriver2ServiceKey, Configuration.ComposeUrl)
				break

			case internal.MockMqttDriver3ServiceKey:
				executor.StartDockerContainerCompose(internal.MockMqttDriver3ServiceKey, Configuration.ComposeUrl)
				break
